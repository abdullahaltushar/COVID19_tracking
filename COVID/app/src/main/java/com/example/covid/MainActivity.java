...
public class MainActivity extends AppCompatActivity {
    TextView tvCases,tvRecoverd,tvCritical,tvActive,todayCases,totalDeaths,todayDeath,affectedCounties;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        affectedCounties=findViewById(R.id.afftdcounties);
        simpleArcLoader=findViewById(R.id.loader);
        scrollView=findViewById(R.id.ScollStarts);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            affectedCounties.setText(jsonObject.getString("affectedCountries"));
    ...
    public void goTrackCountries(View view) {
        startActivity(new Intent(getApplicationContext(),AffecttedCounties.class));
    }
}